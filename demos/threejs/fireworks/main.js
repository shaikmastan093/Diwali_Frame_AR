...
function init_threeScene(spec) {
  ...
  // Load the PNG texture and create the background material
const textureLoader = new THREE.TextureLoader();
const backgroundTexture = textureLoader.load('./images/frame.png', function(texture) {
  // Create a mesh using the texture and your existing geometry
  const backgroundMesh = new THREE.Mesh(
    threeStuffs.videoMesh.geometry, // Assuming this is your geometry
    create_mat2d(texture, true) // Use the function to create the material
  );
  ...
  const calqueMesh = new THREE.Mesh(threeStuffs.videoMesh.geometry, create_mat2d(new THREE.TextureLoader().load('./images/zepto snapy.png'), true))
